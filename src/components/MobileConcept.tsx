...
function HomeScreen({ navigate, userName, summary, transactions, accounts, loans, investmentBreakdown, settings, onSaveSettings, onAddTransaction, onDeleteTransaction, onEditTransaction, onRepayLoan, onWithdrawInvestment }: { navigate: (screen: Screen) => void } & MobileConceptProps) {
